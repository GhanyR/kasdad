export interface Material {
  ...
  gradient: string;
  topics: string[];
  category: "foundations" | "data" | "models" | "evaluation" | "exam";
}
...
export const MATERIALS: Material[] = [
  ...
  },
  {
    ...
    subtitle: "Ringkasan Lengkap Materi UTS",
    icon: "📚",
    color: "#8b5cf6",
    gradient: "from-purple-500/20 to-violet-600/20",
    topics: ["Ringkasan Semua Materi", "Key Concepts", "Formulas", "Tips & Tricks"],
    category: "exam",
  },
  {
    slug: "uts-practice",
    week: 8,
    title: "UTS Practice",
    subtitle: "Latihan Soal & Pembahasan",
    icon: "✏️",
    color: "#ec4899",
    gradient: "from-pink-500/20 to-fuchsia-600/20",
    topics: ["Latihan Soal", "Pembahasan", "Practice Problems", "Self-Assessment"],
    category: "exam",
  },
];
...
export const CATEGORIES = {
  ...
  exam: { label: "UTS Preparation", icon: "🎯", color: "#8b5cf6" },
};
